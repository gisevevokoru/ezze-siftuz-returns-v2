...
'details' => '\EzzeSiftuz\ReturnsV2\Model\ReturnedItemStatusData'    ];
...
const STATUS_MISDIRECTED = 'MISDIRECTED';
...
self::STATUS_SHIPPED,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['occurred_time'] = isset($data['occurred_time']) ? $data['occurred_time'] : null;
     ...
     * Sets status
     *
     * @param string $status Current return status of item.
     *
     * @return $this
     */
    ...
    {
        return $this->container['occurred_time'];
    }

    /**
     * Sets occurred_time
     *
     * @param string $occurred_time Date when the last status was updated.
     *
     * @return $this
     */
    public function setOccurredTime($occurred_time)
    {
        $this->container['occurred_time'] = $occurred_time;
     ...
     * Gets details
     *
     * @return \EzzeSiftuz\ReturnsV2\Model\ReturnedItemStatusData
     */
     ...
     * Sets details
     *
     * @param \EzzeSiftuz\ReturnsV2\Model\ReturnedItemStatusData $details details
     *
     * @return $this
     */
